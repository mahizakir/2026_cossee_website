...
This page gathers organizations, tools, and networks that are relevant to research synthesis, meta-research, reproducibility, and open science in ecology and evolution.
...
Use this list as a starting point for finding methods communities, training pathways, synthesis infrastructure, and broader open-science networks that connect with COSSEE's work.

For planning-focused material, see [Protocols](/protocols/). For the broader framing of this part of the site, see [Open Science](/open-science/).
