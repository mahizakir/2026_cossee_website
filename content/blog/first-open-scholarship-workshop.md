...
tags = ["open science", "workshop", "meta-research"]
+++
...
.osw-duo .blog-inline-figure { margin: 0; }
@media (max-width: 600px) {
  .osw-duo { grid-template-columns: 1fr; }
}
</style>

<p class="osw-meta">University of Alberta &nbsp;·&nbsp; 28 May 2026 &nbsp;·&nbsp; Digital Scholarship Centre</p>

<div class="osw-stats">
  <div><b>23</b><span>Participants</span></div>
  <div><b>7</b><span>Short talks</span></div>
  <div><b>3</b><span>Discussion tracks</span></div>
  <div><b>1</b><span>Morning</span></div>
</div>
...
<figure class="blog-inline-figure">
  <img src="/web_files/open-scholarship-workshop-talk.webp" alt="A speaker presenting a slide to a seated audience during one of the short talks at the workshop." />
  <figcaption>One of seven short talks during the morning session.</figcaption>
</figure>

<div class="osw-duo">
  <figure class="blog-inline-figure">
    <img src="/web_files/open-scholarship-workshop-talk-2.webp" alt="A speaker presenting a slide during a short talk at the workshop." />
    <figcaption>Each speaker took open scholarship from a different angle.</figcaption>
  </figure>
  <figure class="blog-inline-figure">
    <img src="/web_files/open-scholarship-workshop-talk-3.webp" alt="A speaker presenting a slide titled 'Artificial intelligence and automation in knowledge synthesis'." />
    <figcaption>One talk looked at AI and automation in knowledge synthesis.</figcaption>
  </figure>
</div>
...
<figure class="blog-inline-figure">
  <img src="/web_files/open-scholarship-workshop-discussion.webp" alt="Workshop participants seated around tables in small groups during the breakout discussion tracks." />
  <figcaption>Breaking into three tracks to turn talks into priorities.</figcaption>
</figure>
