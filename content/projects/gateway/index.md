...
subtitle = "Georeferencing Ant TErritory With Alberta's Youth"
status = "Recruiting Alberta classrooms"
lead = "COSSEE and St. Mary's University"
audience = "Science instructors in Alberta, Grades 4-12"
...
gallery_images = [
  "ant/Formica obscuriventris foraging on aphids.JPG",
  "ant/DSC_1132.JPG",
  "ant/DSC_1149.JPG",
  "ant/DSC_1155.JPG",
...
highlights = [
  ...
  { label = "Research focus", value = "Mapping the boundary of a suspected ant supercolony" },
  { label = "Student task", value = "Run 10-minute ant aggression trials in small groups" },
  { label = "Output", value = "A shared Alberta-wide dataset and future publication" },
]
what_we_provide = [
...
timeline_steps = [
  { phase = "Late May 2026", detail = "The research team carries out initial fieldwork and analyses in Fish Creek Provincial Park." },
  { phase = "June 2026", detail = "Early participating classrooms can run the activity before the school year ends." },
  { phase = "Fall 2026", detail = "Additional classrooms can join when school resumes, weather permitting." },
  { phase = "October 2026", detail = "The main activity window closes as ant activity drops with colder weather." },
]
form_fields = [
  "Teacher name",
  "School name and city",
  "Grade taught",
  "Preferred timing for participation",
  "Email address",
